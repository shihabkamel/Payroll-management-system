<?php
include('dep_up_delete.php');

if(isset($_GET['edit1'])){
    $id = $_GET['edit1'];
    echo $id;
    $rec = mysqli_query($connection, "SELECT * FROM department WHERE Depart_id=$id;");
    $record=mysqli_fetch_array($rec);
    
$name=$record['Depart_name'];
...
<!-- !PAGE CONTENT! -->
  ...
  <!-- Header -->
      ...
      <div class="w3-display-container w3-text-blue" style="font-size: 50px">
          ...
          <div class="w3-display-middle w3-large" > <h1 >Edit deparment</h1></div>
      </div>
      <div class="w3-container" style="padding: 50px 200px 20px 200px">
      
      
      <form class="w3-container" action="dep_updatephp.php" method="post">
                    ...
                    <p><label>Department Id</label>
                     ...
                     <label>Name</label>
                        <input class="w3-input w3-light-grey w3-animate-input" type="text" name="depname" value="<?php echo $name;?>">
